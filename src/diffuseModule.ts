...
export function diffuseModuleCode({
  ...
  return wgsl/*wgsl*/ `
    ...
    @group(0) @binding(1) var readTex: texture_storage_2d<${texFormat}, read>;
    @group(0) @binding(2) var writeTex: texture_storage_2d<${texFormat}, write>;
    @group(0) @binding(3) var prevTex: texture_storage_2d<${texFormat}, read>;
